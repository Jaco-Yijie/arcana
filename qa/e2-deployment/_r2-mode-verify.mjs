...
writeFileSync('/Users/wangyijie/Desktop/arcana/qa/e2-deployment/online-artwork.json', JSON.stringify({
  mode:'local server + remote R2 artwork', profile:PROFILE, r2Base:R2,
